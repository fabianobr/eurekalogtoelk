...
## eurekalogtoelk -h
	...
	Usage:
	   eurekalogtoelk.py -p <path> -a <elastic host:port> [-f <file with field list>]
		   ...
		   -a      Address with host (port is optional) for elasticsearch instalation. Example: 192.168.0.2 or 10.0.100.20:9210;
...
* Using of command line arguments like usage says;
